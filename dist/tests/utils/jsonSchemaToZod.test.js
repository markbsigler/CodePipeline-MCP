...
const jsonSchemaToZod_1 = require("../../src/utils/jsonSchemaToZod");
describe('jsonSchemaToZod', () => {
    it('converts string schema', () => {
        const schema = { type: 'string', minLength: 2, maxLength: 5 };
        const zodSchema = (0, jsonSchemaToZod_1.jsonSchemaToZod)(schema);
    ...
    it('returns z.any for unknown schema', () => {
        const zodSchema = (0, jsonSchemaToZod_1.jsonSchemaToZod)(undefined);
...
//# sourceMappingURL=jsonSchemaToZod.test.js.map